    ...
    "connected": [
      {
        ...
        "location": {
          ...
          "longitude": 9.491,
          "metro_code": 0,
          "hostname": "node01.betanet.phaeton.prolina.org"
        }
      }
    ],
    "disconnected": [
...
#### Params
 ...
 - `address` - sender or recipient PHA address
 - `senderId` - sender PHA address
 - `recipientId` - recipient PHA address
